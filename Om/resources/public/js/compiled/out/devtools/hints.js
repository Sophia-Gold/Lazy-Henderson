...
var reader = (function (){var or__6938__auto__ = devtools.prefs.pref.call(null,new cljs.core.Keyword(null,"file-reader","file-reader",-450847664));
...
var min_length = (function (){var or__6938__auto__ = devtools.prefs.pref.call(null,new cljs.core.Keyword(null,"sanity-hint-min-length","sanity-hint-min-length",104958154));
if(cljs.core.truth_(or__6938__auto__)){
return or__6938__auto__;
} else {
return (128);
...
}catch (e18317){var _e = e18317;
return false;
}});
devtools.hints.type_error_to_string = (function devtools$hints$type_error_to_string(self){
var temp__6751__auto___18320 = devtools.hints.get_processed_errors_BANG_.call(null);
if(cljs.core.truth_(temp__6751__auto___18320)){
var seen_errors_18321 = temp__6751__auto___18320;
if(cljs.core.truth_(seen_errors_18321.has(self))){
} else {
seen_errors_18321.add(self);

var temp__6753__auto___18322 = devtools.hints.error_object_sense.call(null,self);
if(cljs.core.truth_(temp__6753__auto___18322)){
var sense_18323 = temp__6753__auto___18322;
self.message = [cljs.core.str(self.message),cljs.core.str(", a sanity hint:\n"),cljs.core.str(sense_18323)].join('');
} else {
}
}
} else {
...
//# sourceMappingURL=hints.js.map?rel=1492673033800