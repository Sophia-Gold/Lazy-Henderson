...
var o__15002__auto___18291 = (function (){var o__15002__auto__ = (function (){var o__15002__auto__ = Promise;
return goog.object.get(o__15002__auto__,"resolve").call(o__15002__auto__);
})();
return goog.object.get(o__15002__auto__,"then").call(o__15002__auto__,callback);
})();
goog.object.get(o__15002__auto___18291,"catch").call(o__15002__auto___18291,devtools.async.rethrow_outside_promise);
...
var G__18293_18294 = Error;
var target__15021__auto___18295 = G__18293_18294;
if(cljs.core.truth_(target__15021__auto___18295)){
} else {
throw (new Error([cljs.core.str("Assert failed: "),cljs.core.str([cljs.core.str("unable to locate object path "),cljs.core.str(null),cljs.core.str(" in "),cljs.core.str(G__18293_18294)].join('')),cljs.core.str("\n"),cljs.core.str("target__15021__auto__")].join('')));
}

goog.object.set(target__15021__auto___18295,cljs.core.last.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, ["stackTraceLimit"], null)),Infinity);
...
//# sourceMappingURL=async.js.map?rel=1492673033721