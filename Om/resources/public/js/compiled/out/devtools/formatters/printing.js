...
var len__8121__auto___17576 = arguments.length;
var i__8122__auto___17577 = (0);
while(true){
if((i__8122__auto___17577 < len__8121__auto___17576)){
args__8128__auto__.push((arguments[i__8122__auto___17577]));

var G__17578 = (i__8122__auto___17577 + (1));
i__8122__auto___17577 = G__17578;
continue;
} else {
}
break;
...
return devtools.formatters.printing.build_markup.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),(arguments[(1)]),argseq__8129__auto__);
});
...
devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq17573){
var G__17574 = cljs.core.first.call(null,seq17573);
var seq17573__$1 = cljs.core.next.call(null,seq17573);
var G__17575 = cljs.core.first.call(null,seq17573__$1);
var seq17573__$2 = cljs.core.next.call(null,seq17573__$1);
return devtools.formatters.printing.build_markup.cljs$core$IFn$_invoke$arity$variadic(G__17574,G__17575,seq17573__$2);
});
...
if(cljs.core.truth_((function (){var or__6938__auto__ = devtools.formatters.helpers.directly_printable_QMARK_.call(null,value);
...
devtools.formatters.printing.TemplateWriter.cljs$lang$ctorPrWriter = (function (this__7590__auto__,writer__7591__auto__,opt__7592__auto__){
return cljs.core._write.call(null,writer__7591__auto__,"devtools.formatters.printing/TemplateWriter");
});
...
if(cljs.core.truth_((function (){var and__6926__auto__ = cljs.core.not.call(null,devtools.formatters.printing.already_reference_QMARK_.call(null,group));
if(and__6926__auto__){
var or__6938__auto__ = devtools.formatters.helpers.expandable_QMARK_.call(null,obj);
if(cljs.core.truth_(or__6938__auto__)){
return or__6938__auto__;
} else {
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_.call(null,new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__17579_SHARP_){
return cljs.core.some_QMARK_.call(null,cljs.core.meta.call(null,p1__17579_SHARP_));
})))){
...
var markup_db = cljs.core.get.call(null,map__17588__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
if(cljs.core.truth_((function (){var or__6938__auto__ = (function (){try{if(!((obj == null))){
...
}catch (e17592){var e__15027__auto__ = e17592;
return false;
}})();
if(cljs.core.truth_(or__6938__auto__)){
return or__6938__auto__;
...
}catch (e17594){var e__15027__auto__ = e17594;
return false;
}}
})())){
...
var _STAR_current_state_STAR_17599 = devtools.formatters.state._STAR_current_state_STAR_;
devtools.formatters.state._STAR_current_state_STAR_ = devtools.formatters.state.get_current_state.call(null);

try{var map__17600 = opts;
...
var markup_db = cljs.core.get.call(null,map__17600__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR_17599;
}});
...
;
var temp__6751__auto___17605 = devtools.formatters.state.get_managed_print_level.call(null);
if(cljs.core.truth_(temp__6751__auto___17605)){
var managed_print_level_17606 = temp__6751__auto___17605;
var _STAR_print_level_STAR_17604_17607 = cljs.core._STAR_print_level_STAR_;
cljs.core._STAR_print_level_STAR_ = managed_print_level_17606;

try{devtools.formatters.state.update_current_state_BANG_.call(null,((function (_STAR_print_level_STAR_17604_17607,managed_print_level_17606,temp__6751__auto___17605,writer,opts,job_fn){
return (function (p1__17602_SHARP_){
return devtools.formatters.state.set_managed_print_level.call(null,p1__17602_SHARP_,null);
});})(_STAR_print_level_STAR_17604_17607,managed_print_level_17606,temp__6751__auto___17605,writer,opts,job_fn))
);

job_fn.call(null);
}finally {cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR_17604_17607;
}} else {
job_fn.call(null);
}
...
//# sourceMappingURL=printing.js.map?rel=1492673033004