...
var G__17535 = devtools.prefs.pref.call(null,v);
v = G__17535;
continue;
} else {
return v;
...
var and__6926__auto__ = cljs.core.not.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"disable-cljs-fn-formatting","disable-cljs-fn-formatting",1903786837)));
if(and__6926__auto__){
var and__6926__auto____$1 = !(cljs.core.var_QMARK_.call(null,value));
...
var or__6938__auto__ = (function (){try{if(!((value == null))){
...
}catch (e17548){var e__15027__auto__ = e17548;
return false;
}})();
if(cljs.core.truth_(or__6938__auto__)){
return or__6938__auto__;
} else {
var or__6938__auto____$1 = (function (){try{if(!((value == null))){
...
}catch (e17552){var e__15027__auto__ = e17552;
return false;
}})();
...
}catch (e17554){var e__15027__auto__ = e17554;
return false;
}}
}
});
devtools.formatters.helpers.cljs_type_QMARK_ = (function devtools$formatters$helpers$cljs_type_QMARK_(f){
var and__6926__auto__ = goog.isObject(f);
if(cljs.core.truth_(and__6926__auto__)){
var and__6926__auto____$1 = cljs.core.not.call(null,devtools.formatters.helpers.is_prototype_QMARK_.call(null,f));
if(and__6926__auto____$1){
...
var and__6926__auto__ = goog.isObject(value);
if(cljs.core.truth_(and__6926__auto__)){
...
var or__6938__auto__ = devtools.formatters.helpers.cljs_instance_QMARK_.call(null,value);
if(cljs.core.truth_(or__6938__auto__)){
return or__6938__auto__;
} else {
...
var and__6926__auto__ = (function (){var or__6938__auto__ = devtools.formatters.helpers.cljs_land_value_QMARK_.call(null,value);
if(cljs.core.truth_(or__6938__auto__)){
return or__6938__auto__;
} else {
...
var vec__17559 = devtools.munging.parse_constructor_info.call(null,constructor_fn);
var ns = cljs.core.nth.call(null,vec__17559,(0),null);
var name = cljs.core.nth.call(null,vec__17559,(1),null);
...
var and__6926__auto__ = devtools.formatters.helpers.cljs_instance_QMARK_.call(null,value);
if(cljs.core.truth_(and__6926__auto__)){
...
var or__6938__auto__ = typeof value === 'string';
if(or__6938__auto__){
return or__6938__auto__;
} else {
var or__6938__auto____$1 = typeof value === 'number';
...
return cljs.core.some.call(null,(function (p1__17562_SHARP_){
return cljs.core._EQ_.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__17562_SHARP_);
}),template);
});
...
//# sourceMappingURL=helpers.js.map?rel=1492673032903