...
om.transit.TempIdHandler.cljs$lang$ctorPrWriter = (function (this__27254__auto__,writer__27255__auto__,opt__27256__auto__){
return cljs.core._write.call(null,writer__27255__auto__,"om.transit/TempIdHandler");
});
...
var args41512 = [];
var len__27785__auto___41515 = arguments.length;
var i__27786__auto___41516 = (0);
while(true){
if((i__27786__auto___41516 < len__27785__auto___41515)){
args41512.push((arguments[i__27786__auto___41516]));

var G__41517 = (i__27786__auto___41516 + (1));
i__27786__auto___41516 = G__41517;
continue;
} else {
}
break;
...
break;
default:
throw (new Error([cljs.core.str("Invalid arity: "),cljs.core.str(args41512.length)].join('')));
...
var args41519 = [];
var len__27785__auto___41522 = arguments.length;
var i__27786__auto___41523 = (0);
while(true){
if((i__27786__auto___41523 < len__27785__auto___41522)){
args41519.push((arguments[i__27786__auto___41523]));

var G__41524 = (i__27786__auto___41523 + (1));
i__27786__auto___41523 = G__41524;
continue;
} else {
}
break;
...
break;
default:
throw (new Error([cljs.core.str("Invalid arity: "),cljs.core.str(args41519.length)].join('')));
...
//# sourceMappingURL=transit.js.map?rel=1495936607744