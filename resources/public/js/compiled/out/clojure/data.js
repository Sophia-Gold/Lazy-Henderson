...
return cljs.core.reduce.call(null,(function (result,p__44691){
...
var vec__44698 = clojure.data.diff.call(null,va,vb);
var a_STAR_ = cljs.core.nth.call(null,vec__44698,(0),null);
var b_STAR_ = cljs.core.nth.call(null,vec__44698,(1),null);
var ab = cljs.core.nth.call(null,vec__44698,(2),null);
...
var args44701 = [];
var len__27785__auto___44704 = arguments.length;
var i__27786__auto___44705 = (0);
while(true){
if((i__27786__auto___44705 < len__27785__auto___44704)){
args44701.push((arguments[i__27786__auto___44705]));

var G__44706 = (i__27786__auto___44705 + (1));
i__27786__auto___44705 = G__44706;
continue;
} else {
}
break;
...
break;
default:
throw (new Error([cljs.core.str("Invalid arity: "),cljs.core.str(args44701.length)].join('')));
...
return (function (){var G__44711 = (((clojure.data.equality_partition.call(null,a) instanceof cljs.core.Keyword))?clojure.data.equality_partition.call(null,a).fqn:null);
switch (G__44711) {
case "atom":
...
//# sourceMappingURL=data.js.map?rel=1495936729310