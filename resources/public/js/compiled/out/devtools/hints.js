...
var file = cljs.core.get.call(null,map__40716__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.call(null,map__40716__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.call(null,map__40716__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return devtools.hints.make_sense_of_the_error.call(null,error.message,file,line,column);
}catch (e40715){var _e = e40715;
return false;
}});
devtools.hints.type_error_to_string = (function devtools$hints$type_error_to_string(self){
var temp__6751__auto___40718 = devtools.hints.get_processed_errors_BANG_.call(null);
if(cljs.core.truth_(temp__6751__auto___40718)){
var seen_errors_40719 = temp__6751__auto___40718;
if(cljs.core.truth_(seen_errors_40719.has(self))){
} else {
seen_errors_40719.add(self);

var temp__6753__auto___40720 = devtools.hints.error_object_sense.call(null,self);
if(cljs.core.truth_(temp__6753__auto___40720)){
var sense_40721 = temp__6753__auto___40720;
self.message = [cljs.core.str(self.message),cljs.core.str(", a sanity hint:\n"),cljs.core.str(sense_40721)].join('');
} else {
}
}
} else {
...
//# sourceMappingURL=hints.js.map?rel=1496384623670