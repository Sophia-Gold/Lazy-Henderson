...
var file = cljs.core.get.call(null,map__40731__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.call(null,map__40731__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.call(null,map__40731__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return devtools.hints.make_sense_of_the_error.call(null,error.message,file,line,column);
}catch (e40730){var _e = e40730;
return false;
}});
devtools.hints.type_error_to_string = (function devtools$hints$type_error_to_string(self){
var temp__6751__auto___40733 = devtools.hints.get_processed_errors_BANG_.call(null);
if(cljs.core.truth_(temp__6751__auto___40733)){
var seen_errors_40734 = temp__6751__auto___40733;
if(cljs.core.truth_(seen_errors_40734.has(self))){
} else {
seen_errors_40734.add(self);

var temp__6753__auto___40735 = devtools.hints.error_object_sense.call(null,self);
if(cljs.core.truth_(temp__6753__auto___40735)){
var sense_40736 = temp__6753__auto___40735;
self.message = [cljs.core.str(self.message),cljs.core.str(", a sanity hint:\n"),cljs.core.str(sense_40736)].join('');
} else {
}
}
} else {
...
//# sourceMappingURL=hints.js.map?rel=1496990007735