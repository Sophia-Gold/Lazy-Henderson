...
var o__37631__auto___40704 = (function (){var o__37631__auto__ = (function (){var o__37631__auto__ = Promise;
return goog.object.get(o__37631__auto__,"resolve").call(o__37631__auto__);
})();
return goog.object.get(o__37631__auto__,"then").call(o__37631__auto__,callback);
})();
goog.object.get(o__37631__auto___40704,"catch").call(o__37631__auto___40704,devtools.async.rethrow_outside_promise);
...
var G__40706_40707 = Error;
var target__37650__auto___40708 = G__40706_40707;
if(cljs.core.truth_(target__37650__auto___40708)){
} else {
throw (new Error([cljs.core.str("Assert failed: "),cljs.core.str([cljs.core.str("unable to locate object path "),cljs.core.str(null),cljs.core.str(" in "),cljs.core.str(G__40706_40707)].join('')),cljs.core.str("\n"),cljs.core.str("target__37650__auto__")].join('')));
}

goog.object.set(target__37650__auto___40708,cljs.core.last.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, ["stackTraceLimit"], null)),Infinity);
...
//# sourceMappingURL=async.js.map?rel=1496990007657