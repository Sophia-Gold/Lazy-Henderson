...
var o__44126__auto___45707 = (function (){var o__44126__auto__ = (function (){var o__44126__auto__ = Promise;
return goog.object.get(o__44126__auto__,"resolve").call(o__44126__auto__);
})();
return goog.object.get(o__44126__auto__,"then").call(o__44126__auto__,callback);
})();
goog.object.get(o__44126__auto___45707,"catch").call(o__44126__auto___45707,devtools.async.rethrow_outside_promise);
...
var G__45709_45710 = Error;
var target__44145__auto___45711 = G__45709_45710;
if(cljs.core.truth_(target__44145__auto___45711)){
} else {
throw (new Error([cljs.core.str("Assert failed: "),cljs.core.str([cljs.core.str("unable to locate object path "),cljs.core.str(null),cljs.core.str(" in "),cljs.core.str(G__45709_45710)].join('')),cljs.core.str("\n"),cljs.core.str("target__44145__auto__")].join('')));
}

goog.object.set(target__44145__auto___45711,cljs.core.last.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, ["stackTraceLimit"], null)),Infinity);
...
//# sourceMappingURL=async.js.map?rel=1495936730628