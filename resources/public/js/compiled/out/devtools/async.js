...
var o__8209__auto___11498 = (function (){var o__8209__auto__ = (function (){var o__8209__auto__ = Promise;
return goog.object.get(o__8209__auto__,"resolve").call(o__8209__auto__);
})();
return goog.object.get(o__8209__auto__,"then").call(o__8209__auto__,callback);
})();
goog.object.get(o__8209__auto___11498,"catch").call(o__8209__auto___11498,devtools.async.rethrow_outside_promise);
...
var G__11500_11501 = Error;
var target__8228__auto___11502 = G__11500_11501;
if(cljs.core.truth_(target__8228__auto___11502)){
} else {
throw (new Error([cljs.core.str("Assert failed: "),cljs.core.str([cljs.core.str("unable to locate object path "),cljs.core.str(null),cljs.core.str(" in "),cljs.core.str(G__11500_11501)].join('')),cljs.core.str("\n"),cljs.core.str("target__8228__auto__")].join('')));
}

goog.object.set(target__8228__auto___11502,cljs.core.last.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, ["stackTraceLimit"], null)),Infinity);
...
//# sourceMappingURL=async.js.map?rel=1492242829817