...
var len__27777__auto___39989 = arguments.length;
var i__27778__auto___39990 = (0);
while(true){
if((i__27778__auto___39990 < len__27777__auto___39989)){
args__27784__auto__.push((arguments[i__27778__auto___39990]));

var G__39991 = (i__27778__auto___39990 + (1));
i__27778__auto___39990 = G__39991;
continue;
} else {
}
break;
...
return devtools.formatters.printing.build_markup.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),(arguments[(1)]),argseq__27785__auto__);
});
...
devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq39986){
...
return devtools.formatters.printing.build_markup.cljs$core$IFn$_invoke$arity$variadic(G__39987,G__39988,seq39986__$2);
});
...
if(cljs.core.truth_((function (){var or__26594__auto__ = devtools.formatters.helpers.directly_printable_QMARK_.call(null,value);
...
devtools.formatters.printing.TemplateWriter.cljs$lang$ctorPrWriter = (function (this__27246__auto__,writer__27247__auto__,opt__27248__auto__){
return cljs.core._write.call(null,writer__27247__auto__,"devtools.formatters.printing/TemplateWriter");
});
...
if(cljs.core.truth_((function (){var and__26582__auto__ = cljs.core.not.call(null,devtools.formatters.printing.already_reference_QMARK_.call(null,group));
if(and__26582__auto__){
var or__26594__auto__ = devtools.formatters.helpers.expandable_QMARK_.call(null,obj);
if(cljs.core.truth_(or__26594__auto__)){
return or__26594__auto__;
} else {
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_.call(null,new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__39992_SHARP_){
return cljs.core.some_QMARK_.call(null,cljs.core.meta.call(null,p1__39992_SHARP_));
})))){
...
var markup_db = cljs.core.get.call(null,map__40001__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
if(cljs.core.truth_((function (){var or__26594__auto__ = (function (){try{if(!((obj == null))){
...
}catch (e40005){var e__37656__auto__ = e40005;
return false;
}})();
if(cljs.core.truth_(or__26594__auto__)){
return or__26594__auto__;
...
}catch (e40007){var e__37656__auto__ = e40007;
return false;
}}
})())){
...
var _STAR_current_state_STAR_40012 = devtools.formatters.state._STAR_current_state_STAR_;
devtools.formatters.state._STAR_current_state_STAR_ = devtools.formatters.state.get_current_state.call(null);

try{var map__40013 = opts;
var map__40013__$1 = ((((!((map__40013 == null)))?((((map__40013.cljs$lang$protocol_mask$partition0$ & (64))) || (map__40013.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__40013):map__40013);
var markup_db = cljs.core.get.call(null,map__40013__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR_40012;
}});
...
;
var temp__6751__auto___40018 = devtools.formatters.state.get_managed_print_level.call(null);
if(cljs.core.truth_(temp__6751__auto___40018)){
var managed_print_level_40019 = temp__6751__auto___40018;
var _STAR_print_level_STAR_40017_40020 = cljs.core._STAR_print_level_STAR_;
cljs.core._STAR_print_level_STAR_ = managed_print_level_40019;

try{devtools.formatters.state.update_current_state_BANG_.call(null,((function (_STAR_print_level_STAR_40017_40020,managed_print_level_40019,temp__6751__auto___40018,writer,opts,job_fn){
return (function (p1__40015_SHARP_){
return devtools.formatters.state.set_managed_print_level.call(null,p1__40015_SHARP_,null);
});})(_STAR_print_level_STAR_40017_40020,managed_print_level_40019,temp__6751__auto___40018,writer,opts,job_fn))
);

job_fn.call(null);
}finally {cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR_40017_40020;
}} else {
job_fn.call(null);
}
...
//# sourceMappingURL=printing.js.map?rel=1496990006968