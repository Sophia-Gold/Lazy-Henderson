...
var len__8113__auto___10783 = arguments.length;
var i__8114__auto___10784 = (0);
while(true){
if((i__8114__auto___10784 < len__8113__auto___10783)){
args__8120__auto__.push((arguments[i__8114__auto___10784]));

var G__10785 = (i__8114__auto___10784 + (1));
i__8114__auto___10784 = G__10785;
continue;
} else {
}
break;
...
return devtools.formatters.printing.build_markup.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),(arguments[(1)]),argseq__8121__auto__);
});
...
devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq10780){
...
return devtools.formatters.printing.build_markup.cljs$core$IFn$_invoke$arity$variadic(G__10781,G__10782,seq10780__$2);
});
...
if(cljs.core.truth_((function (){var or__6930__auto__ = devtools.formatters.helpers.directly_printable_QMARK_.call(null,value);
...
devtools.formatters.printing.TemplateWriter.cljs$lang$ctorPrWriter = (function (this__7582__auto__,writer__7583__auto__,opt__7584__auto__){
return cljs.core._write.call(null,writer__7583__auto__,"devtools.formatters.printing/TemplateWriter");
});
...
if(cljs.core.truth_((function (){var and__6918__auto__ = cljs.core.not.call(null,devtools.formatters.printing.already_reference_QMARK_.call(null,group));
if(and__6918__auto__){
var or__6930__auto__ = devtools.formatters.helpers.expandable_QMARK_.call(null,obj);
if(cljs.core.truth_(or__6930__auto__)){
return or__6930__auto__;
} else {
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_.call(null,new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__10786_SHARP_){
return cljs.core.some_QMARK_.call(null,cljs.core.meta.call(null,p1__10786_SHARP_));
})))){
...
var markup_db = cljs.core.get.call(null,map__10795__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
if(cljs.core.truth_((function (){var or__6930__auto__ = (function (){try{if(!((obj == null))){
...
}catch (e10799){var e__8234__auto__ = e10799;
return false;
}})();
if(cljs.core.truth_(or__6930__auto__)){
return or__6930__auto__;
...
}catch (e10801){var e__8234__auto__ = e10801;
return false;
}}
})())){
...
var _STAR_current_state_STAR_10806 = devtools.formatters.state._STAR_current_state_STAR_;
devtools.formatters.state._STAR_current_state_STAR_ = devtools.formatters.state.get_current_state.call(null);

try{var map__10807 = opts;
...
var markup_db = cljs.core.get.call(null,map__10807__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR_10806;
}});
...
;
var temp__6751__auto___10812 = devtools.formatters.state.get_managed_print_level.call(null);
if(cljs.core.truth_(temp__6751__auto___10812)){
var managed_print_level_10813 = temp__6751__auto___10812;
var _STAR_print_level_STAR_10811_10814 = cljs.core._STAR_print_level_STAR_;
cljs.core._STAR_print_level_STAR_ = managed_print_level_10813;

try{devtools.formatters.state.update_current_state_BANG_.call(null,((function (_STAR_print_level_STAR_10811_10814,managed_print_level_10813,temp__6751__auto___10812,writer,opts,job_fn){
return (function (p1__10809_SHARP_){
return devtools.formatters.state.set_managed_print_level.call(null,p1__10809_SHARP_,null);
});})(_STAR_print_level_STAR_10811_10814,managed_print_level_10813,temp__6751__auto___10812,writer,opts,job_fn))
);

job_fn.call(null);
}finally {cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR_10811_10814;
}} else {
job_fn.call(null);
}
...
//# sourceMappingURL=printing.js.map?rel=1492242829187