...
var len__8113__auto___10774 = arguments.length;
var i__8114__auto___10775 = (0);
while(true){
if((i__8114__auto___10775 < len__8113__auto___10774)){
args__8120__auto__.push((arguments[i__8114__auto___10775]));

var G__10776 = (i__8114__auto___10775 + (1));
i__8114__auto___10775 = G__10776;
continue;
} else {
}
break;
...
return devtools.formatters.state.update_current_state_BANG_.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__8121__auto__);
});
...
devtools.formatters.state.update_current_state_BANG_.cljs$lang$applyTo = (function (seq10772){
var G__10773 = cljs.core.first.call(null,seq10772);
var seq10772__$1 = cljs.core.next.call(null,seq10772);
return devtools.formatters.state.update_current_state_BANG_.cljs$core$IFn$_invoke$arity$variadic(G__10773,seq10772__$1);
});
...
return (p1__10777_SHARP_ === object);
});})(history))
,history);
});
...
//# sourceMappingURL=state.js.map?rel=1492242829125