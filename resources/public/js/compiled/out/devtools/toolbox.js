...
var args40443 = [];
var len__27777__auto___40449 = arguments.length;
var i__27778__auto___40450 = (0);
while(true){
if((i__27778__auto___40450 < len__27777__auto___40449)){
args40443.push((arguments[i__27778__auto___40450]));

var G__40451 = (i__27778__auto___40450 + (1));
i__27778__auto___40450 = G__40451;
continue;
} else {
}
break;
...
if(typeof devtools.toolbox.t_devtools$toolbox40446 !== 'undefined'){
} else {
...
*/
devtools.toolbox.t_devtools$toolbox40446 = (function (obj,header,style,tag,meta40447){
this.obj = obj;
this.header = header;
this.style = style;
this.tag = tag;
...
devtools.toolbox.t_devtools$toolbox40446.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_40448,meta40447__$1){
var self__ = this;
var _40448__$1 = this;
return (new devtools.toolbox.t_devtools$toolbox40446(self__.obj,self__.header,self__.style,self__.tag,meta40447__$1));
});

devtools.toolbox.t_devtools$toolbox40446.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_40448){
var self__ = this;
var _40448__$1 = this;
return self__.meta40447;
});

devtools.toolbox.t_devtools$toolbox40446.prototype.devtools$protocols$IFormat$ = true;

devtools.toolbox.t_devtools$toolbox40446.prototype.devtools$protocols$IFormat$_header$arity$1 = (function (_){
var self__ = this;
var ___$1 = this;
...
devtools.toolbox.t_devtools$toolbox40446.prototype.devtools$protocols$IFormat$_has_body$arity$1 = (function (_){
var self__ = this;
var ___$1 = this;
return true;
});

devtools.toolbox.t_devtools$toolbox40446.prototype.devtools$protocols$IFormat$_body$arity$1 = (function (_){
var self__ = this;
var ___$1 = this;
...
devtools.toolbox.t_devtools$toolbox40446.getBasis = (function (){
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"obj","obj",-1672671807,null),new cljs.core.Symbol(null,"header","header",1759972661,null),new cljs.core.Symbol(null,"style","style",1143888791,null),new cljs.core.Symbol(null,"tag","tag",350170304,null),new cljs.core.Symbol(null,"meta40447","meta40447",513715218,null)], null);
});

devtools.toolbox.t_devtools$toolbox40446.cljs$lang$type = true;

devtools.toolbox.t_devtools$toolbox40446.cljs$lang$ctorStr = "devtools.toolbox/t_devtools$toolbox40446";

devtools.toolbox.t_devtools$toolbox40446.cljs$lang$ctorPrWriter = (function (this__27246__auto__,writer__27247__auto__,opt__27248__auto__){
return cljs.core._write.call(null,writer__27247__auto__,"devtools.toolbox/t_devtools$toolbox40446");
});

devtools.toolbox.__GT_t_devtools$toolbox40446 = (function devtools$toolbox$__GT_t_devtools$toolbox40446(obj__$1,header__$1,style__$1,tag__$1,meta40447){
return (new devtools.toolbox.t_devtools$toolbox40446(obj__$1,header__$1,style__$1,tag__$1,meta40447));
});

}

return (new devtools.toolbox.t_devtools$toolbox40446(obj,header,style,tag,cljs.core.PersistentArrayMap.EMPTY));
});
...
//# sourceMappingURL=toolbox.js.map?rel=1496990007462