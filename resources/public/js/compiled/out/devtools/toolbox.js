...
var args46913 = [];
var len__27785__auto___46919 = arguments.length;
var i__27786__auto___46920 = (0);
while(true){
if((i__27786__auto___46920 < len__27785__auto___46919)){
args46913.push((arguments[i__27786__auto___46920]));

var G__46921 = (i__27786__auto___46920 + (1));
i__27786__auto___46920 = G__46921;
continue;
} else {
}
break;
...
break;
default:
throw (new Error([cljs.core.str("Invalid arity: "),cljs.core.str(args46913.length)].join('')));
...
if(typeof devtools.toolbox.t_devtools$toolbox46916 !== 'undefined'){
} else {
...
*/
devtools.toolbox.t_devtools$toolbox46916 = (function (obj,header,style,tag,meta46917){
this.obj = obj;
this.header = header;
this.style = style;
this.tag = tag;
...
devtools.toolbox.t_devtools$toolbox46916.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_46918,meta46917__$1){
var self__ = this;
var _46918__$1 = this;
return (new devtools.toolbox.t_devtools$toolbox46916(self__.obj,self__.header,self__.style,self__.tag,meta46917__$1));
});


devtools.toolbox.t_devtools$toolbox46916.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_46918){
var self__ = this;
var _46918__$1 = this;
...
devtools.toolbox.t_devtools$toolbox46916.prototype.devtools$protocols$IFormat$ = true;


devtools.toolbox.t_devtools$toolbox46916.prototype.devtools$protocols$IFormat$_header$arity$1 = (function (_){
var self__ = this;
var ___$1 = this;
...
devtools.toolbox.t_devtools$toolbox46916.prototype.devtools$protocols$IFormat$_has_body$arity$1 = (function (_){
var self__ = this;
var ___$1 = this;
return true;
});
...
devtools.toolbox.t_devtools$toolbox46916.prototype.devtools$protocols$IFormat$_body$arity$1 = (function (_){
var self__ = this;
var ___$1 = this;
...
devtools.toolbox.t_devtools$toolbox46916.getBasis = (function (){
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"obj","obj",-1672671807,null),new cljs.core.Symbol(null,"header","header",1759972661,null),new cljs.core.Symbol(null,"style","style",1143888791,null),new cljs.core.Symbol(null,"tag","tag",350170304,null),new cljs.core.Symbol(null,"meta46917","meta46917",-2047339536,null)], null);
});

devtools.toolbox.t_devtools$toolbox46916.cljs$lang$type = true;

devtools.toolbox.t_devtools$toolbox46916.cljs$lang$ctorStr = "devtools.toolbox/t_devtools$toolbox46916";

devtools.toolbox.t_devtools$toolbox46916.cljs$lang$ctorPrWriter = (function (this__27254__auto__,writer__27255__auto__,opt__27256__auto__){
return cljs.core._write.call(null,writer__27255__auto__,"devtools.toolbox/t_devtools$toolbox46916");
});

devtools.toolbox.__GT_t_devtools$toolbox46916 = (function devtools$toolbox$__GT_t_devtools$toolbox46916(obj__$1,header__$1,style__$1,tag__$1,meta46917){
return (new devtools.toolbox.t_devtools$toolbox46916(obj__$1,header__$1,style__$1,tag__$1,meta46917));
});

}

return (new devtools.toolbox.t_devtools$toolbox46916(obj,header,style,tag,cljs.core.PersistentArrayMap.EMPTY));
});
...
//# sourceMappingURL=toolbox.js.map?rel=1496386707788