...
var args38950 = [];
var len__27777__auto___38956 = arguments.length;
var i__27778__auto___38957 = (0);
while(true){
if((i__27778__auto___38957 < len__27777__auto___38956)){
args38950.push((arguments[i__27778__auto___38957]));

var G__38958 = (i__27778__auto___38957 + (1));
i__27778__auto___38957 = G__38958;
continue;
} else {
}
break;
...
break;
default:
throw (new Error([cljs.core.str("Invalid arity: "),cljs.core.str(args38950.length)].join('')));
...
if(typeof devtools.toolbox.t_devtools$toolbox38953 !== 'undefined'){
} else {
...
*/
devtools.toolbox.t_devtools$toolbox38953 = (function (obj,header,style,tag,meta38954){
this.obj = obj;
this.header = header;
this.style = style;
this.tag = tag;
...
devtools.toolbox.t_devtools$toolbox38953.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_38955,meta38954__$1){
var self__ = this;
var _38955__$1 = this;
return (new devtools.toolbox.t_devtools$toolbox38953(self__.obj,self__.header,self__.style,self__.tag,meta38954__$1));
});

devtools.toolbox.t_devtools$toolbox38953.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_38955){
var self__ = this;
var _38955__$1 = this;
return self__.meta38954;
});

devtools.toolbox.t_devtools$toolbox38953.prototype.devtools$protocols$IFormat$ = true;

devtools.toolbox.t_devtools$toolbox38953.prototype.devtools$protocols$IFormat$_header$arity$1 = (function (_){
var self__ = this;
var ___$1 = this;
...
devtools.toolbox.t_devtools$toolbox38953.prototype.devtools$protocols$IFormat$_has_body$arity$1 = (function (_){
var self__ = this;
var ___$1 = this;
return true;
});

devtools.toolbox.t_devtools$toolbox38953.prototype.devtools$protocols$IFormat$_body$arity$1 = (function (_){
var self__ = this;
var ___$1 = this;
...
devtools.toolbox.t_devtools$toolbox38953.getBasis = (function (){
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"obj","obj",-1672671807,null),new cljs.core.Symbol(null,"header","header",1759972661,null),new cljs.core.Symbol(null,"style","style",1143888791,null),new cljs.core.Symbol(null,"tag","tag",350170304,null),new cljs.core.Symbol(null,"meta38954","meta38954",2144619329,null)], null);
});

devtools.toolbox.t_devtools$toolbox38953.cljs$lang$type = true;

devtools.toolbox.t_devtools$toolbox38953.cljs$lang$ctorStr = "devtools.toolbox/t_devtools$toolbox38953";

devtools.toolbox.t_devtools$toolbox38953.cljs$lang$ctorPrWriter = (function (this__27246__auto__,writer__27247__auto__,opt__27248__auto__){
return cljs.core._write.call(null,writer__27247__auto__,"devtools.toolbox/t_devtools$toolbox38953");
});

devtools.toolbox.__GT_t_devtools$toolbox38953 = (function devtools$toolbox$__GT_t_devtools$toolbox38953(obj__$1,header__$1,style__$1,tag__$1,meta38954){
return (new devtools.toolbox.t_devtools$toolbox38953(obj__$1,header__$1,style__$1,tag__$1,meta38954));
});

}

return (new devtools.toolbox.t_devtools$toolbox38953(obj,header,style,tag,cljs.core.PersistentArrayMap.EMPTY));
});
...
//# sourceMappingURL=toolbox.js.map?rel=1496888105150